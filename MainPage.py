...
class MainPage:
    ...
    def __init__(self):
        ...
        self.main_window.title("Train Brain")
        ...
        title_fp = open(self.BASE_DIR + "/res/Images/brain.jpg", "rb")
        ...
        start_fp = open(self.BASE_DIR + "/res/Images/start.jpg", "rb")
        ...
        boyA_fp = open(self.BASE_DIR + "/res/Images/boyAlphabet.jpg", "rb")
        ...
        girlN_fp = open(self.BASE_DIR + "/res/Images/girlNumber.jpg", "rb")
        ...
        boyV_fp = open(self.BASE_DIR + "/res/Images/boyVegetable.jpg", "rb")
        ...
        boyF_fp = open(self.BASE_DIR + "/res/Images/boyFruit.jpg", "rb")
        ...
        girlH_fp = open(self.BASE_DIR + "/res/Images/girlHalloween.png", "rb")
